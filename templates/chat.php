...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    botResponseContainer.innerHTML = `
        ...
        <div class="msg-bubble">
            ...
            <div class="animated-bot-response"></div>
        </div>
    `;
    ...
    const textElement = botResponseContainer.querySelector('.animated-bot-response');
    ...
    chatLog.innerHTML += `
        <div class="msg right-msg">
            ...
            <div class="msg-bubble">
                ...
                <div class="question msg-text">${userInput}</div>
            </div>
        </div>
    `;

    // Make an HTTP request to your Flask route for the chatbot
    fetch("/chatbot", {
        method: "POST",
        headers: {
